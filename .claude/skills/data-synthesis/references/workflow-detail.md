# Data Synthesis - Detailed Reference

This file contains detailed pattern examples, conflict resolution frameworks, a complete narrative example, and full JSON output template.

## Cross-Channel Pattern Examples
...
SYNTHESIS:
CONFLICT - Your LinkedIn underperformance might be execution issue, not channel issue
...
## Opportunity Prioritization - Full Example
...
## Complete Strategic Narrative Example

```markdown
## Strategic Narrative: AcmeCorp Marketing Analysis

### Current State
AcmeCorp has built a strong product with unique features (real-time collaboration, built-in
video) and competitive pricing ($29/user). However, the company faces a visibility crisis
...
The company produces 1/3 the content volume (4 posts/month vs 12) with 1/3 the depth
(520 words vs 1,450 words) compared to competitors. This content gap cascades across
all channels:
...
2. Positioning White Space: Mid-market gap between enterprise and SMB solutions
3. Paid Efficiency: Google Ads ROAS of 4.2 shows strong unit economics
